    ...
    <div id="ndcontent">
        ...
        <table border="0px" style="width: 90%">
            <tr>
                ...
                <td width="33%">
                    <asp:TextBox ID="txtPassword" Width="300px" Height="20px" runat="server" Style="margin-left: 30px" TextMode="Password" ></asp:TextBox>
            ...
            <tr>
                ...
                <td width="33%">
                    <asp:TextBox ID="txtPass" Width="300px" Height="20px" runat="server"  Style="margin-left: 30px" TextMode="Password" ></asp:TextBox>
            ...
            <tr>
                ...
                <td width="33%">
                    <asp:TextBox ID="txtCfPass" Width="300px" Height="20px" runat="server"  Style="margin-left: 30px" TextMode="Password" ></asp:TextBox>
